...
import (
	...
	chaosv1alpha1 "github.com/szlabs/kooper/examples/pod-terminator-operator/apis/chaos/v1alpha1"
	"github.com/szlabs/kooper/examples/pod-terminator-operator/service/chaos"
)
