...
import (
    ...
    "github.com/szlabs/kooper/operator/controller/leaderelection"
    ...
)
...
docker run --name ctrl1 \
    ...
    -v `pwd`:/go/src/github.com/szlabs/kooper:ro  \
    golang go run /go/src/github.com/szlabs/kooper/examples/leader-election-controller/main.go
```
...
[leaderelection-src]: https://github.com/szlabs/kooper/tree/master/operator/controller/leaderelection
[leaderelection-example]: https://github.com/szlabs/kooper/tree/master/examples/leader-election-controller