...
import (
	...
	superherov1alpha1 "github.com/szlabs/kooper/test/integration/operator/apis/superhero/v1alpha1"
	integrationtestk8scli "github.com/szlabs/kooper/test/integration/operator/client/k8s/clientset/versioned"
